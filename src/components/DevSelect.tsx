...
// since we want to customize the select element
...
function DevSelect({
	...
	return (
		<>
			...
			<Field
				{...props}
				className={`bg-light-200 border-0  rounded-lg px-4 py-2 md:px-5 md:py-3  lg:px-6 lg:py-3 block ${className} ${errorClasses}`} component="select"
			>
				{options.map((e) => {
